...
EDJE_PART_INVALID_VOID(efl_text_markup_cursor_markup_insert, _efl_canvas_layout_part_invalid_efl_text_markup_markup_insert, Efl_Text_Cursor_Cursor *cur, const char *markup)
