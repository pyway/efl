...
//#define LKU(x) printf("%s: **unlock**\n", __func__); _on_unlock_hook(); eina_lock_release(&(x))
// FWD Declaration
...
_relayout_if_needed(Evas_Object *eo_obj, Efl_Canvas_Text_Data *o)
{
   ...
   if (o->formatted.valid)
     {
        ...
        //printf("OUT: 1 _relayout_if_needed\n");
        return EINA_TRUE;
     }
   if (o->layout_th)
     {
        ...
        //printf(" -- waiting\n");
        ecore_thread_wait(o->layout_th, 0.5);
        if (!o->rendering)
          {
             LKL(o->lk);
          }
   ...
   //printf("OUT: 2 _relayout_if_needed\n");
   return EINA_TRUE;
}
                             ...
                             int x, int y, Eina_Bool do_async)
{
   ...
   if (o->changed || o->content_changed || o->format_changed || o->obstacle_changed)
     {
        o->rendering = EINA_TRUE;
       _relayout_if_needed(eo_obj, o);
        o->rendering = EINA_FALSE;
     }
...
_efl_canvas_text_async_async_layout(Eo *eo_obj EINA_UNUSED, void *_pd EINA_UNUSED)
{
   ...
   if (o->formatted.valid)
     {
        Efl_Canvas_Text_Async_Layout_Event_Info data;
        data.w = o->formatted.w;
        data.h = o->formatted.h;
        LKU(o->lk);
