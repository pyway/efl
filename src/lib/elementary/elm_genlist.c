...
EOLIAN static void
_elm_genlist_efl_ui_focus_manager_setup_on_first_touch(Eo *obj, Elm_Genlist_Data *sd, Efl_Ui_Focus_Direction direction, Efl_Ui_Focus_Object *entry)
{
   Elm_Object_Item *eo_it = NULL;
        ...
        if (eo_it != sd->focused_item)
          {
             ...
             if (it->realized)
             ...
             else
               {
                  ...
                  printf("SCHEUDULING ASDASDASDASDASDASD %p %p\n", it, eo_it);
               }
          }
     }
   else
